...
namespace Muco
{
    public class AndroidNativeVolumeService : VolumeService
    {
        ...
        override public float GetSystemVolume()
        {
        ...
        override public void SetSystemVolume(float volumeValue)
        {
