...
namespace Muco {
    public class GameObjectMenu_PickUp : MonoBehaviour
    {
        private const string PrefabPath = "Packages/com.phenomenalviborg.muco/Runtime/Interactibles/Prefab/PickUp.prefab";
        [MenuItem("GameObject/MUCO/PickUp")]
        public static void SpawnMyPrefab(MenuCommand menuCommand)
        {
            ...
            if (instance != null)
            {
                ...
                Undo.RegisterCreatedObjectUndo(instance, "Spawn Button");
        ...
        [MenuItem("GameObject/MUCO/PickUp", true)]
