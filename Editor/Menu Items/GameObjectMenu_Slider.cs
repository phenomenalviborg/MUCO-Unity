...
namespace Muco {
    public class GameObjectMenu_Slider : MonoBehaviour
    {
        private const string PrefabPath = "Packages/com.phenomenalviborg.muco/Runtime/Interactibles/Prefab/Slider.prefab";
        [MenuItem("GameObject/MUCO/Slider")]
        ...
        [MenuItem("GameObject/MUCO/Slider", true)]
